...
import { DD_CNA_AGREGATS_codes } from "./DD_CNA_AGREGATS/DD_CNA_AGREGATS_codes";
import { DDCNAAPU_Shape } from "./DD_CNA_APU/DD_CNA_APU_shape";
import { DD_CNA_APU_codes } from "./DD_CNA_APU/DD_CNA_APU_codes";
import { DDCNABRANCHES_Shape } from "./DD_CNA_BRANCHES/DD_CNA_BRANCHES_shape";
import { DD_CNA_BRANCHES_codes } from "./DD_CNA_BRANCHES/DD_CNA_BRANCHES_codes";
import { DDCNACONSOMENAGESCOICOP_Shape } from "./DD_CNA_CONSO_MENAGES_COICOP/DD_CNA_CONSO_MENAGES_COICOP_shape";
import { DD_CNA_CONSO_MENAGES_COICOP_codes } from "./DD_CNA_CONSO_MENAGES_COICOP/DD_CNA_CONSO_MENAGES_COICOP_codes";
