...
export type MATURITY_code_values =
  (typeof MATURITY_codes)[keyof typeof MATURITY_codes];
...
export type VALUATION_code_values =
  (typeof VALUATION_codes)[keyof typeof VALUATION_codes];
...
export const STO_codes = {
  ...
  Total_des_recettes_des_administrations_publiquesen_pourcentage_du_PIB__OTR_PPIB:
    "_OTR_PPIB",
  ...
  Capitalisation_de_la_production_pour_emploi_final_propre_P51G_CPEFP:
    "P51G_CPEFP",
  ...
  Total_des_dépenses_des_administrations_publiques_en_pourcentage_du_PIB__OTE_PPIB:
    "_OTE_PPIB",
  /** Épargne brute */
  ...
  "Autres_transferts_en_capital_et_aides_à_l’investissement_à_recevoir_D9N":
    "D9N",
...
export const CONSOLIDATION_codes = {
  ...
  Partiellement_consolidé_ou_agrégat_contenant_à_la_fois_des_valeurs_consolidées_et_non_consolidées_P:
    "P",
  /** FC_INTRA_INTER */
...
export type CONSOLIDATION_code_values =
  (typeof CONSOLIDATION_codes)[keyof typeof CONSOLIDATION_codes];
...
export type COUNTERPART_SECTOR_code_values =
  (typeof COUNTERPART_SECTOR_codes)[keyof typeof COUNTERPART_SECTOR_codes];
