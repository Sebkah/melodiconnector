 ...
 */ export type DDCNAAGREGATSShape = {
  dimensions: Prettify<DDCNAAGREGATSDimensions>;
...
export type TRANSFORMATION_code_values =
  (typeof TRANSFORMATION_codes)[keyof typeof TRANSFORMATION_codes];
...
export type PRICES_code_values =
  (typeof PRICES_codes)[keyof typeof PRICES_codes];
export const EXPENDITURE_codes = {
  ...
  "Assurances_(hors_assurance-vie)_et_services_financiers_CP121P_122":
    "CP121P_122",
...
export type EXPENDITURE_code_values =
  (typeof EXPENDITURE_codes)[keyof typeof EXPENDITURE_codes];
export const STO_codes = {
  ...
  Part_de_la_valeur_ajoutée_des_ei_dans_la_valeur_ajoutée_totale_des_enf__PART_VAENF:
    "_PART_VAENF",
  /** Taux de marge */
  ...
  "Revenu_mixte_brut_des_ei_/_excédent_brut_d’exploitation_et_revenu_mixte_brut_des_enf__REVENU":
    "_REVENU",
  /** Taux de marge */
  ...
  Part_des_cantines_dans_le_revenu_disponible_brut__CANTINE_REVENU:
    "_CANTINE_REVENU",
  /** Part de la dépense liée au logement dans le revenu disponible brut */
  Part_de_la_dépense_liée_au_logement_dans_le_revenu_disponible_brut__DEP_LOGT_REVENU:
    "_DEP_LOGT_REVENU",
  /** Part des assurances (hors assurance-vie) et services financiers dans le revenu disponible brut */
  "Part_des_assurances_(hors_assurance-vie)_et_services_financiers_dans_le_revenu_disponible_brut__ASSUR_REVENU":
    "_ASSUR_REVENU",
  /** Part des services de télévision et de télécommunications dans le revenu disponible brut */
  Part_des_services_de_télévision_et_de_télécommunications_dans_le_revenu_disponible_brut__TELE_REVENU:
    "_TELE_REVENU",
  /** Part de la dépense pré-engagée dans le revenu disponible brut */
  "Part_de_la_dépense_pré-engagée_dans_le_revenu_disponible_brut__DEP_REVENU":
    "_DEP_REVENU",
  /** Part de la dépense pré-engagée dans la dépense de consommation finale des ménages */
  "Part_de_la_dépense_pré-engagée_dans_la_dépense_de_consommation_finale_des_ménages__DEP_CONSO":
    "_DEP_CONSO",
  ...
  "Emploi_total_(peut_être_en_personnes_physiques,_équivalent_temps_plein_ou_en_heures_travaillées)_EMP":
    "EMP",
  ...
  "Emploi_des_travailleurs_indépendants_dans_les_unités_de_production_résidentes_(peut_être_en_personnes_physiques,_équivalent_temps_plein_ou_en_heures_travaillées)_SELF":
    "SELF",
  ...
  "Emploi_des_salariés_dans_les_unités_de_production_résidentes_(peut_être_en_personnes_physiques,_équivalent_temps_plein_ou_en_heures_travaillées)_SAL":
    "SAL",
  ...
  "Emploi_déclaré_des_salariés_dans_les_unités_de_production_résidentes_(peut_être_en_personnes_physiques,_équivalent_temps_plein_ou_en_heures_travaillées)_SALD":
    "SALD",
  /** Production marchande, production pour emploi final propre et paiements au titre de la production non marchande */
  "Production_marchande,_production_pour_emploi_final_propre_et_paiements_au_titre_de_la_production_non_marchande_P1O":
    "P1O",
  ...
  "Variation_stocks_+_Acquis,_moins_cessions_objets_valeur_(OPP52+OPP53)_P5M":
    "P5M",
  /** Impôts en capital */
  Impôts_en_capital_D91: "D91",
  /** Contribution à l’évolution du PIB de la dépense de consommation finale */
  "Contribution_à_l’évolution_du_PIB_de_la_dépense_de_consommation_finale_CONTRIB_PIB_P3":
    "CONTRIB_PIB_P3",
  /** Contribution à l’évolution du PIB de la dépense de consommation individuelle */
  "Contribution_à_l’évolution_du_PIB_de_la_dépense_de_consommation_individuelle_CONTRIB_PIB_P31":
    "CONTRIB_PIB_P31",
  /** Contribution à l’évolution du PIB de la dépense de consommation collective */
  "Contribution_à_l’évolution_du_PIB_de_la_dépense_de_consommation_collective_CONTRIB_PIB_P32":
    "CONTRIB_PIB_P32",
  ...
  "Contribution_à_l’évolution_du_PIB_de_la_FBCF_CONTRIB_PIB_P51G":
    "CONTRIB_PIB_P51G",
  /** Contribution à l’évolution du PIB de la variation des stocks */
  "Contribution_à_l’évolution_du_PIB_de_la_variation_des_stocks_CONTRIB_PIB_P52":
    "CONTRIB_PIB_P52",
  /** Contribution à l’évolution du PIB des acquisitions moins cessions d’objets de valeur */
  "Contribution_à_l’évolution_du_PIB_des_acquisitions_moins_cessions_d’objets_de_valeur_CONTRIB_PIB_P53":
    "CONTRIB_PIB_P53",
  /** Contribution à l’évolution du PIB du solde des exportations */
  "Contribution_à_l’évolution_du_PIB_du_solde_des_exportations_CONTRIB_PIB_P6":
    "CONTRIB_PIB_P6",
  /** Contribution à l’évolution du PIB du solde des importations */
  "Contribution_à_l’évolution_du_PIB_du_solde_des_importations_CONTRIB_PIB_P7":
    "CONTRIB_PIB_P7",
  ...
  "Impôts_sur_production_et_importations,_moins_subventions_(D2+D3)_D2X3":
    "D2X3",
  /** PIB par habitant */
  ...
  "Contribution_à_l’évolution_du_PIB_du_solde_des_échanges_extérieurs_CONTRIB_PIB_B11":
    "CONTRIB_PIB_B11",
  /** Revenu national brut en termes réels par habitant */
  Revenu_national_brut_en_termes_réels_par_habitant__RNB_REEL_HABITANT:
    "_RNB_REEL_HABITANT",
  /** Formation brute de capital/Formation nette de capital en autres changements de volume et ajustements */
  "Formation_brute_de_capital/Formation_nette_de_capital_en_autres_changements_de_volume_et_ajustements_KA_P5":
    "KA_P5",
  /** Formation brute de capital/Formation nette de capital en gains/pertes nominaux de détention */
  "Formation_brute_de_capital/Formation_nette_de_capital_en_gains/pertes_nominaux_de_détention_K7_P5":
    "K7_P5",
  /** Formation brute de capital fixe en gains/pertes nominaux de détention */
  "Formation_brute_de_capital_fixe_en_gains/pertes_nominaux_de_détention_K7_P51G":
    "K7_P51G",
  /** Variation des stocks en autres changements de volume et ajustements */
  Variation_des_stocks_en_autres_changements_de_volume_et_ajustements_KA_P52:
    "KA_P52",
  ...
  "Acquisitions_moins_cessions_d’objets_de_valeur_en_gains/pertes_nominaux_de_détention_K7_P53":
    "K7_P53",
  ...
  Cotisations_sociales_effectives_obligatoires_à_la_charge_des_salariés_D613CE:
    "D613CE",
  ...
  "Solde_des_transferts_courants_(reçus_moins_versés)_TRANSF_COURANT":
    "TRANSF_COURANT",
  /** Pouvoir d’achat du rdb arbitrable par unité de consommation */
  "Pouvoir_d’achat_du_rdb_arbitrable_par_unité_de_consommation__PAA_UC":
    "_PAA_UC",
  ...
  "Pouvoir_d’achat_du_rdb_arbitrable_par_personne__PAA_PERSONNE":
    "_PAA_PERSONNE",
  ...
  Autres_impôts_sur_la_production_moins_autres_subventions_sur_la_production_D29X39:
    "D29X39",
  ...
  "Impôts_sur_les_produits,_à_l‘exclusion_de_la_TVA_et_des_impôts_sur_les_importations_D214":
    "D214",
  ...
  Cotisations_sociales_effectives_à_la_charge_des_travailleurs_indépendants_D613CS:
    "D613CS",
  ...
  "Transferts_courants_entre_administrations_publiques_(solde)_(voir_note)_D73S":
    "D73S",
  ...
  "Impôts_sur_les_importations,_à_l’exclusion_de_la_TVA_et_des_droits_sur_les_importations_D2122":
    "D2122",
  ...
  "Revenus_d’investissements_attribués_aux_détenteurs_de_parts_de_fonds_d’investissement_D443":
    "D443",
  ...
  "Cotisations_sociales_effectives_à_la_charge_des_personnes_n’occupant_pas_un_emploi_D613CN":
    "D613CN",
  ...
  Produit_total_des_impôts_et_cotisations_sociales_après_déduction_des_montants_dus_non_recouvrables_ODB:
    "ODB",
  ...
  "Charge_fiscale_=_produit_total_des_impôts_et_cotisations_sociales_obligatoires_après_déduction_des_montants_dus_non_recouvrables_ODD":
    "ODD",
  ...
  "Produit_total_des_impôts_et_cotisations_sociales_nettes_(y_compris_cotisations_sociales_imputées)_après_déduction_des_montants_dus_non_recouvrables_ODC":
    "ODC",
  ...
  "Écart_entre_capacité_ou_besoin_de_financement_et_solde_des_flux_nets_d’actifs_et_passifs_financiers_(B9NF_–_B9F)_B9FX9":
    "B9FX9",
  /** Variations de la valeur nette due à l’épargne et aux transferts de capital */
  "Variations_de_la_valeur_nette_due_à_l’épargne_et_aux_transferts_de_capital_B101":
    "B101",
  /** Variation valeur nette dues aux changements de volume et ajustement */
  Variation_valeur_nette_dues_aux_changements_de_volume_et_ajustement_B102:
    "B102",
  ...
  "Impôts_sur_le_revenu_des_personnes_physiques_ou_des_ménages,_y_compris_les_gains_de_détention_(D51a_+_D51c1)_D51M":
    "D51M",
  /** Impôts sur le revenu ou les bénéfices des sociétés, y compris les gains de détention (D51b + D51c2) */
  "Impôts_sur_le_revenu_ou_les_bénéfices_des_sociétés,_y_compris_les_gains_de_détention_(D51b_+_D51c2)_D51O":
    "D51O",
  ...
  "Production_pour_usage_final_propre,_coût_imputable_à_la_rémunération_des_salariés_(finalité_GFSM)_P12_GFSM_D1":
    "P12_GFSM_D1",
  /** Production pour usage final propre, coût imputable à la consommation intermédiaire (finalité GFSM) */
  "Production_pour_usage_final_propre,_coût_imputable_à_la_consommation_intermédiaire_(finalité_GFSM)_P12_GFSM_P2":
    "P12_GFSM_P2",
  /** Production pour usage final propre, coût imputable à la consommation de capital fixe (finalité GFSM) */
  "Production_pour_usage_final_propre,_coût_imputable_à_la_consommation_de_capital_fixe_(finalité_GFSM)_P12_GFSM_P51C":
    "P12_GFSM_P51C",
  /** Partie des crédits d’impôts qui excède les créances des contribuables */
  "Partie_des_crédits_d’impôts_qui_excède_les_créances_des_contribuables_TC":
    "TC",
  ...
  "Subventions_à_payer_(signe_positif,_pour_la_déclaration_dans_la_présentation_des_SFP)_D3P":
    "D3P",
  ...
  "Montants_compensatoires_monétaires_prélevés_a_l’importation_D2122B":
    "D2122B",
  /** Droits d’accise */
  ...
  Impôts_sur_les_opérations_financières_et_les_opérations_en_capital_D214C:
    "D214C",
  ...
  "Impôts_fonciers,_impôts_immobiliers_ou_impôts_sur_d’autres_structures_D29A":
    "D29A",
  ...
  "Impôts_sur_le_revenu_des_personnes_physiques_ou_des_ménages,_a_l’exclusion_des_gains_de_détention_D51A":
    "D51A",
  /** Impôts sur le revenu ou les bénéfices des sociétés a l’exclusion des gains de détention */
  "Impôts_sur_le_revenu_ou_les_bénéfices_des_sociétés_a_l’exclusion_des_gains_de_détention_D51B":
    "D51B",
  ...
  "Paiements_effectués_par_les_ménages_en_vue_de_l’obtention_de_licences_D59D":
    "D59D",
  ...
  Cotisations_sociales_effectives_obligatoires_à_la_charge_des_employeurs_D611C:
    "D611C",
  /** Cotisations sociales effectives obligatoires à la charge des ménages */
  Cotisations_sociales_effectives_obligatoires_à_la_charge_des_ménages_D613C:
    "D613C",
  ...
  Cotisations_sociales_effectives_à_la_charge_des_employeurs_dues_non_recouvrables_D995E:
    "D995E",
  /** Cotisations sociales effectives à la charge des salariés dues non recouvrables */
  Cotisations_sociales_effectives_à_la_charge_des_salariés_dues_non_recouvrables_D995FE:
    "D995FE",
  /** Cotisations sociales effectives a la charge des non employés dues non recouvrables */
  Cotisations_sociales_effectives_a_la_charge_des_non_employés_dues_non_recouvrables_D995FN:
    "D995FN",
  /** Cotisations sociales effectives à la charge des travailleurs indépendants dues non recouvrable */
  Cotisations_sociales_effectives_à_la_charge_des_travailleurs_indépendants_dues_non_recouvrable_D995FS:
    "D995FS",
  /** Cotisations sociales effectives à la charge des ménages dues non recouvrables */
  Cotisations_sociales_effectives_à_la_charge_des_ménages_dues_non_recouvrables_D995F:
    "D995F",
  ...
  "Autres_impôts_sur_la_production_+_impôts_courants_sur_le_revenu,_le_patrimoine,_etc,_+_ajustement_pour_variations_des_droits_à_pension_OED":
    "OED",
  ...
  "Consommation_intermédiaire_+_autres_impôts_sur_la_production_+_impôts_courants_sur_le_revenu,_le_patrimoine,_etc,_+_ajustement_pour_variations_des_droits_à_pension_OEC":
    "OEC",
...
export type ACCOUNTING_ENTRY_code_values =
  (typeof ACCOUNTING_ENTRY_codes)[keyof typeof ACCOUNTING_ENTRY_codes];
export const PRODUCT_codes = {
  /** Total */
  Total__T: "_T",
} as const;
export type PRODUCT_code_values =
...
export const REF_SECTOR_codes = {
  ...
  "Administrations_locales_(à_l’exclusion_de_la_sécurité_sociale)_S1313":
    "S1313",
  /** Administration centrale (à l’exclusion de la sécurité sociale) */
  "Administration_centrale_(à_l’exclusion_de_la_sécurité_sociale)_S1311":
    "S1311",
  ...
  "APU,_ménages_et_institutions_sans_but_lucratif_au_services_des_ménages_S1L":
    "S1L",
  /** Sociétés financières : services principalement financiers, hors assurance */
  "Sociétés_financières_:_services_principalement_financiers,_hors_assurance_S12K64":
    "S12K64",
  /** Sociétés financières : services principalement d’auxiliaires financiers */
  "Sociétés_financières_:_services_principalement_d’auxiliaires_financiers_S12K66":
    "S12K66",
  ...
  "Administrations_publiques_et_institutions_et_organes_de_l’Union_européenne_SZV":
    "SZV",
  /** Non sectorisé */
  Non_sectorisé_S1N: "S1N",
  /** Administration d’états fédérés (à l’exclusion de la sécurité sociale) */
  "Administration_d’états_fédérés_(à_l’exclusion_de_la_sécurité_sociale)_S1312":
    "S1312",
  /** Reste du monde */
...
export type REF_SECTOR_code_values =
  (typeof REF_SECTOR_codes)[keyof typeof REF_SECTOR_codes];
export const COUNTERPART_AREA_codes = {
  ...
  "Intérieur_vis-à-vis_du_monde_plus_reste_du_monde_vis-à-vis_de_lintérieur_W08":
    "W08",
  ...
  "Pays_de_l’Union_Européenne_participant_au_mécanisme_de_surveillance_unique_B01":
    "B01",
  /** Pays membres de la Zone Euro (composition fixe, au 1er janvier 2023) */
  "Pays_membres_de_la_Zone_Euro_(composition_fixe,_au_1er_janvier_2023)_I9":
    "I9",
  /** Pays membres de l’Union Européenne et hors de la Zone Euro (composition fixe, au 1er janvier 2023) */
  "Pays_membres_de_l’Union_Européenne_et_hors_de_la_Zone_Euro_(composition_fixe,_au_1er_janvier_2023)_K11":
    "K11",
  /** Pays hors pays membres de l’Union Européenne (composition fixe, au 31 janvier 2020,  post brexit) */
  "Pays_hors_pays_membres_de_l’Union_Européenne_(composition_fixe,_au_31_janvier_2020,_post_brexit)_D6":
    "D6",
  /** Pays membres de l’Union Européenne (composition fixe, au 31 janvier 2020, post brexit) */
  "Pays_membres_de_l’Union_Européenne_(composition_fixe,_au_31_janvier_2020,_post_brexit)_B6":
    "B6",
  /** Pays hors pays membres de la Zone Euro (composition fixe, au 1er janvier 2023) */
  "Pays_hors_pays_membres_de_la_Zone_Euro_(composition_fixe,_au_1er_janvier_2023)_J9":
    "J9",
} as const;
export type COUNTERPART_AREA_code_values =
  (typeof COUNTERPART_AREA_codes)[keyof typeof COUNTERPART_AREA_codes];
...
export type UNIT_MEASURE_code_values =
  (typeof UNIT_MEASURE_codes)[keyof typeof UNIT_MEASURE_codes];
export const INSTR_ASSET_codes = {
  ...
  "Machines_et_équipement_+_systèmes_d’armes_(N113_+_N114)_(brut)_N11MG":
    "N11MG",
  /** Autres machines et équipements + systèmes d’armes (N1139+N114) (brut) */
  "Autres_machines_et_équipements_+_systèmes_d’armes_(N1139+N114)_(brut)_N11OG":
    "N11OG",
  /** Actifs fixes par type d’actifs (net) */
  "Actifs_fixes_par_type_d’actifs_(net)_N11N": "N11N",
} as const;
export type INSTR_ASSET_code_values =
  (typeof INSTR_ASSET_codes)[keyof typeof INSTR_ASSET_codes];
export const ACTIVITY_codes = {
  /** Total */
  Total__T: "_T",
} as const;
export type ACTIVITY_code_values =
  (typeof ACTIVITY_codes)[keyof typeof ACTIVITY_codes];
export const OBS_STATUS_codes = {
  ...
  "Valeur_manquante_:_les_données_existent_mais_ne_sont_pas_collectées_(non_disponible_:_nd)_L":
    "L",
...
export type OBS_STATUS_code_values =
  (typeof OBS_STATUS_codes)[keyof typeof OBS_STATUS_codes];
export const CONF_STATUS_codes = {
  /** Diffusable */
  Diffusable_F: "F",
} as const;
export type CONF_STATUS_code_values =
  (typeof CONF_STATUS_codes)[keyof typeof CONF_STATUS_codes];
...
export type OBS_STATUS_FR_code_values =
  (typeof OBS_STATUS_FR_codes)[keyof typeof OBS_STATUS_FR_codes];
